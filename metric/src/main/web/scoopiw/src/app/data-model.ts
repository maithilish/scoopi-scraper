...
export const nameLabelMap = [
    ...
    { name: 'PageLoader.fetch.web', label: 'Web fetch ' },
    { name: 'PageLoader.fetch.resource', label: 'Resource fetch ' },
    { name: 'PageLoader.fetch.local', label: 'local fetch ' },
    ...
    { name: 'PageLoader.task.time', label: 'Document fetch and load' },
