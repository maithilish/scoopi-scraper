...
public class DataDefHelperTest {
    ...
    public void testCreateDataDefs() throws IOException {
        ...
        given(yamls.toJson(def1)).willReturn(defJson1);
        given(yamls.toJson(def2)).willReturn(defJson2);
    ...
    public void testMarkForUpdationNoExistingDataDef() {
        ...
        boolean actual = dataDefDefs.markForUpdation(newDataDefs, oldDataDefs);
    ...
    public void testSetDefs() throws IOException {
        ...
        given(yamls.toJsonNode(defJson1)).willReturn(def1);
        given(yamls.toJsonNode(defJson2)).willReturn(def2);
    ...
    public void testGetAxisSets() throws IOException {
        ...
        List<Set<Axis>> actual = dataDefDefs.getAxisSets(dataDef);
    ...
    public void testGetData() throws IOException {
        ...
        given(objectFactory.createItemMig()).willReturn(item1, item2);

        Data actual = dataDefDefs.getData(dataDef, axisSets);
